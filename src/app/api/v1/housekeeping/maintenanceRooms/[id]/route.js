...
export async function GET(request, context) {
    ...
    const response = await prisma.maintenanceRooms.findUnique({
        where: {
...
export async function PATCH(request, context) {
    ...
    try {
        ...
        const updateRecord = await prisma.maintenanceRooms.update({
            where: {
                IDmaintenance: parseInt(id),
            },
            data: {
...
export async function DELETE(request, context) {
    ...
    try {
        ...
        const deleteRecord = await prisma.maintenanceRooms.delete({
            where: {
                IDmaintenance: parseInt(id),
            }
        })
