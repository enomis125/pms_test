...
export function salutation(idSalutation){
...
function handleUpdateSalutation(e) {
    ...
    return { handleInputSalutation , handleSubmitSalutation, handleUpdateSalutation, setValuesSalutation, valuesSalutation };
}