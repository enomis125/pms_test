...
import PricesGroupsTableForm from "@/components/modal/settings/pricesGroupsTable/page";
  ...
  return (
    <main>
      <div className="flex flex-col mt-3 py-3">
        <p className="text-xs px-6">Grupo de tabelas de preços</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <PricesGroupsTableForm
            buttonName={"Novo"}
            buttonIcon={<FiPlus size={15} />}
            buttonColor={"primary"}
            modalHeader={"Inserir Grupo"}
            modalIcons={"bg-red"}
            formTypeModal={11}
          />
        </div>
