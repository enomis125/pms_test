...
const Card = () => {
    return (
        ...
        <div className="">
            ...
            <div className="">
                <Cartao counter2={"12"} title={"VERIFICADOS"} description={""}  listType={"#"} icon={<PiListPlus size={35} />} formTypeCard={0}/>
            </div>
            <div className="">
                <Cartao counter3={"53"}  title={"SUJOS"} description={""}  listType={"#"} icon={<FaBoxesStacked size={35}/>} formTypeCard={0}/>
            </div>
            <div className="">
                <Cartao counter4={"0"} title={"FORA DE SERVIÇO"} description={""}   icon={<PiListDashesBold  size={35}/>} listType={"#"} formTypeCard={0}/>
            </div>
        </div>
        </>
    )
