  ...
  return (
    <main>
      <div className="flex flex-col mt-5 py-3">
        <p className="text-xs px-6">Motivos de Reservas</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <FormModals
            buttonName={"Inserir Motivo de Reserva"}
            buttonIcon={<FiPlus size={15} />}
            buttonColor={"primary"}
            modalHeader={"Inserir Motivo de Reserva"}
            modalIcons={"bg-red"}
            formTypeModal={0}
          ></FormModals>
        </div>
                  ...
                  <DropdownMenu aria-label="Static Actions" closeOnSelect={false} isOpen={true}>
                    <DropdownItem key="edit">
                      <FormModals
                        ...
                        modalHeader={"Editar Motivo de Reserva"}
                        formTypeModal={0}
                      ></FormModals>
                    </DropdownItem>
