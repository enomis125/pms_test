      ...
      <div className="mx-5 h-[65vh] min-h-full">
        ...
        >
          <TableHeader>
            ...
            <TableColumn className="bg-primary-600 text-white font-bold">FUNÇÃO</TableColumn>
            <TableColumn className="bg-primary-600 text-white font-bold">ORDEM</TableColumn>
            <TableColumn className="bg-primary-600 text-white font-bold">GRUPO TIPOLOGIA</TableColumn>
