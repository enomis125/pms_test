  ...
  return (
    <main>
      <div className="flex flex-col mt-3 py-3">
        <p className="text-xs px-6">{t("hotel.maintenance.label")}</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <MaintenanceForm
            ...
            buttonColor={"primary"}
            modalHeader={t("hotel.maintenance.new.modalHeader")}
            modalIcons={"bg-red"}
            formTypeModal={11}
          ></MaintenanceForm>
        </div>
                ...
                {items.map((maintenance, index) => (
                  <TableRow key={index}>
                    <TableCell className="text-right underline text-blue-600"><MaintenanceForm
                      ...
                      modalHeader={t("hotel.maintenance.edit.modalHeader")}
                    ...
                    <TableCell className="flex justify-end">
                      <Dropdown>
                        ...
                        <DropdownMenu aria-label="Static Actions" closeOnSelect={false} isOpen={true}>
                          ...
                          <DropdownItem key="delete" onClick={() => handleDelete(maintenance.maintenanceID)}>{t("general.removeRecord")}</DropdownItem>
