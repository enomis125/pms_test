  ...
  return (
    <main>
      <div className="flex flex-col my-10 py-3">
        <p className="text-xs px-6">Documento de Identificação</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <FormModals
            buttonName={"Inserir Documento Identificação"}
            buttonIcon={<FiPlus size={15} />}
            buttonColor={"primary"}
            modalHeader={"Inserir Documento de Identificação"}
            modalIcons={"bg-red"}
            formTypeModal={41}
          ></FormModals>
        </div>
                    ...
                    <DropdownMenu aria-label="Static Actions" closeOnSelect={false} isOpen={true}>
                      <DropdownItem key="edit">
                        <FormModals
                          ...
                          modalHeader={"Editar Documento de Identificação"}
                          formTypeModal={41}
                        ></FormModals>
                      </DropdownItem>
