  ...
  return (
    <main>
      <div className="flex flex-col my-10 py-3">
        <p className="text-xs px-6">Método de Conhecimento</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <FormModals
            buttonName={"Inserir Método Conhecimento"}
            buttonIcon={<FiPlus size={15} />}
            buttonColor={"primary"}
            modalHeader={"Inserir Método de Conhecimento"}
            modalIcons={"bg-red"}
            formTypeModal={41}
          ></FormModals>
        </div>
                  ...
                  <DropdownMenu aria-label="Static Actions" closeOnSelect={false} isOpen={true}>
                    <DropdownItem key="edit">
                      <FormModals
                        ...
                        modalHeader={"Editar Método de Conhecimento"}
                        formTypeModal={41}
                      ></FormModals>
                    </DropdownItem>
