  ...
  return (
    <main>
      <div className="flex flex-col my-10 py-3">
        <p className="text-xs px-6">Preferências de Clientes</p>
        <div className="flex flex-row justify-between items-center mx-5">
          ...
          <FormModals
            buttonName={"Inserir Preferência de Cliente"}
            buttonIcon={<FiPlus size={15} />}
            buttonColor={"primary"}
            modalHeader={"Inserir Preferência de Cliente"}
            modalIcons={"bg-red"}
            formTypeModal={41}
          ></FormModals>
        </div>
                  ...
                  <DropdownMenu aria-label="Static Actions" closeOnSelect={false} isOpen={true}>
                    <DropdownItem key="edit">
                      <FormModals
                        ...
                        modalHeader={"Editar Preferência de Cliente"}
                        formTypeModal={41}
                      ></FormModals>
                    </DropdownItem>
