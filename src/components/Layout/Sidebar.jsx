...
const Sidebar = ({ showSidebar, setShowSidebar, children, name }) => {
    ...
    return (
        <>
            <aside className={(showSidebar ? "" : "hidden ") + "h-screen border-r border-bg-primary  overflow-auto w-72 flex shrink-0 fixed top-0 z-40 inset-0 lg:block"} aria-label="Sidebar">
