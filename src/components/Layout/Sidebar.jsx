    ...
    const listItems = {
        ...
        frontoffice :{
            ...
            items: [
                ...
                {
                    ref: "/homepage/frontOffice/tipologyPlan", label: t('sidebar.frontoffice.tipologiesPlan'), active: true
                },
                {
                    ref: "/homepage/frontOffice/reservationPlan", label: t('sidebar.frontoffice.reservationsPlan'), active: true
