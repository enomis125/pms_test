...
const formModals = ({ idDepartment,
    ...
    return (
        <>
                            ...
                            {(onClose) => (
                                <>
                                    <form onSubmit={(e) => handleUpdateDepartments(e)}>
                                        ...
                                        <ModalBody className="flex flex-col mx-5 my-5 space-y-8">
                                            <input type="text" value={valuesDepartments.Abreviature} onChange={e => setValuesDepartments({ ...valuesDepartments, Abreviature: e.target.value })} className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"></input>
                                            <input type="text" value={valuesDepartments.Description} onChange={e => setValuesDepartments({ ...valuesDepartments, Description: e.target.value })} placeholder="Abreviatura" className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"></input>
                                            <div>
                                                <input id="link-checkbox" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"></input>
                                                <label for="link-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ativo (estado).</label>
                                            </div>
                                            <textarea type="textarea" value={valuesDepartments.Order} onChange={e => setValuesDepartments({ ...valuesDepartments, Order: e.target.value })} placeholder="Ordem" className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-10 px-4"></textarea>
                                        </ModalBody>
                                    </form>
            ...
            {formTypeModal === 21 && ( //account groups insert
                <>
                    <Button onPress={onOpen} color={buttonColor} className="w-fit">
                        {buttonName} {buttonIcon}
                    </Button>
            ...
            {formTypeModal === 22 && ( //account groups edit
                <>
                    <Button fullWidth={true} size="md" onPress={onOpen} color={buttonColor} className="-h-3 flex justify-start -p-3">
                        {buttonName} {buttonIcon}
                    </Button>
                            ...
                            {(onClose) => (
                                <>
                                    <form onSubmit={(e) => handleUpdateDepartments(e)}>
                                        ...
                                        <ModalBody className="flex flex-col mx-5 my-5 space-y-8">
                                            <input type="text" value={valuesDepartments.Cod} onChange={e => setValuesDepartments({ ...valuesDepartments, Cod: e.target.value })} placeholder="Cod." className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"></input>
                                            <input type="text" value={valuesDepartments.Abreviature} onChange={e => setValuesDepartments({ ...valuesDepartments, Abreviature: e.target.value })} placeholder="Abreviatura" className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"></input>
                                            <input type="text" value={valuesDepartments.Description} onChange={e => setValuesDepartments({ ...valuesDepartments, Description: e.target.value })} placeholder="Descrição" className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"></input>
                                            <textarea type="textarea" value={valuesDepartments.Order} onChange={e => setValuesDepartments({ ...valuesDepartments, Order: e.target.value })} placeholder="Ordem" className="w-full bg-transparent outline-none border-b-2 border-gray-500 h-10 px-4"></textarea>
                                        </ModalBody>
                                    </form>
                                    <ModalFooter className="absolute bottom-0 left-0 flex flex-col text-right bg-tableFooter border border-tableFooterBorder w-full text-gray-600 text-sm">
            ...
            {formTypeModal === 31 && ( //revenue account insert
                <>
                    <Button onPress={onOpen} color={buttonColor} className="w-fit">
                        {buttonName} {buttonIcon}
                    </Button>
            ...
            {formTypeModal === 32 && ( //revenue account edit
                <>
                    <Button fullWidth={true} size="md" onPress={onOpen} color={buttonColor} className="-h-3 flex justify-start -p-3">
                        {buttonName} {buttonIcon}
                    </Button>
