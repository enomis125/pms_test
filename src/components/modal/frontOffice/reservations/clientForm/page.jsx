                            ...
                            {(onClose) => (
                                <>
                                    <form onSubmit={handleSubmiIndividual}>
                                        ...
                                        <ModalBody className="flex flex-row mx-5 my-5 space-y-8 overflow-y-auto" style={{ maxHeight: '80vh' }}>
                                            <div className="flex flex-row">
                                                <Tabs aria-label="Options" isVertical="true">
                                                    <Tab key="individuals" title="Individuais">
                                                    ...
                                                    <Tab key="company" title="Empresas">
                                                    <div className="flex flex-col ml-10">
                                                    <div className="bg-white flex flex-row justify-between items-center py-5 px-5 mb-5 border boder-neutral-200">
                                                <InputFieldControlled
                                                    type={"text"}
