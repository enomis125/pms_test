...
const formModals = ({
  ...
  function handleSubmit(event) {
    ...
    if (
      ...
      !caracteristica.Abreviature ||
      !caracteristica.Details
    ) {
      alert("Preencha os campos corretamente");
      return;
    }
    axios
      .put("/api/hotel/caracteristicas", caracteristica)
                  ...
                  <>
                    ...
                    <ModalBody className="flex flex-col mx-5 my-5 space-y-8">
                      ...
                      <input
                        type="text"
                        placeholder="Ordem"
                        className="w-1/2 bg-transparent outline-none border-b-2 border-gray-500 h-14 px-4"
                      ></input>
                ...
                <>
                  ...
                  <ModalBody>
                    ...
                    <div className="flex gap-4 items-center max-w-xs">
                      <Button size="md">Configuração de interfaces</Button>
                    </div>
                    <div className="w-full flex flex-col gap-4">
                      {variants.map((variant) => (
                        <div
