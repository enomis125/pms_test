...
const clientPreferenceForm = ({
    ...
    return (
        <>
            ...
            {formTypeModal === 11 && ( //client preference insert
                <>
            ...
            {
                formTypeModal === 12 && ( //client preference edit
                    <>
                                            ...
                                            <form onSubmit={(e) => handleUpdateCustomerPreferences(e)}>
                                                ...
                                                <ModalBody className="flex flex-col mx-5 my-5 space-y-8">
                                                    ...
                                                    <InputFieldControlled
                                                        ...
                                                        label={"Descrição"}
                                                        ariaLabel={"Descrição"}
                                                        value={valuesCustomerPreferences.Descrition}
                                                        onChange={e => setValuesCustomerPreferences({ ...valuesCustomerPreferences, Descrition: e.target.value })} />
